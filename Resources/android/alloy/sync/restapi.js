...
function Sync(method, model, opts) {
    ...
    (_.isObject(params.urlparams) || model.config.URLPARAMS) && _.extend(params.urlparams, _.isFunction(model.config.URLPARAMS) ? model.config.URLPARAMS() : model.config.URLPARAMS);
