!function() {
    ...
    function createConsoleLogger(type) {
        console[type] = function() {
            ...
            if (!mocha._ti_quiet) {
                if (0 === args.length) args.push(isStudio ? util.cursor.reset + " " + util.cursor.reset : util.cursor.resetLine); else {
    ...
    require.register("browser/diff.js", function(module) {
        var JsDiff = function() {
            ...
            function removeEmpty(array) {
                var ret = [];
                for (var i = 0; i < array.length; i++) array[i] && ret.push(array[i]);
                return ret;
            }
            ...
            return {
                ...
                createPatch: function(fileName, oldStr, newStr, oldHeader, newHeader) {
                    ...
                    for (var i = 0; i < diff.length; i++) {
                        ...
                        if (current.added || current.removed) {
                            ...
                            if (oldRangeStart) if (lines.length <= 8 && i < diff.length - 2) curRange.push.apply(curRange, contextLines(lines)); else {
                                ...
                                lines.length <= 4 && eofNL(ret, i, current);
                                oldRangeStart = 0;
                                newRangeStart = 0;
                                curRange = [];
                            }
                ...
                applyPatch: function(oldStr, uniDiff) {
                    ...
                    for (var i = "I" === diffstr[0][0] ? 4 : 0; i < diffstr.length; i++) if ("@" === diffstr[i][0]) {
                    ...
                    for (var i = diff.length - 1; i >= 0; i--) {
                        var d = diff[i];
                        for (var j = 0; j < d.oldlength; j++) if (str[d.start - 1 + j] !== d.oldlines[j]) return false;
    ...
    require.register("reporters/dot.js", function(module, exports, require) {
        function Dot(runner) {
            Base.call(this, runner);
            var self = this, width = (this.stats, .75 * Base.window.width | 0), n = 0;
            runner.on("start", function() {
            ...
            runner.on("pass", function(test) {
                ++n % width == 0 && process.stdout.write("\n  ");
                process.stdout.write("slow" == test.speed ? color("bright yellow", Base.symbols.dot) : color(test.speed, Base.symbols.dot));
            });
    ...
    require.register("reporters/html.js", function(module, exports, require) {
        ...
        function unhide() {
            ...
            for (var i = 0; i < els.length; ++i) els[i].className = els[i].className.replace("suite hidden", "suite");
        }
    ...
    require.register("reporters/json-cov.js", function(module, exports, require) {
        ...
        function map(cov) {
            ...
            ret.sloc > 0 && (ret.coverage = ret.hits / ret.sloc * 100);
            return ret;
        }
    ...
    require.register("reporters/landing.js", function(module, exports, require) {
        function Landing(runner) {
            ...
            Base.call(this, runner);
            var self = this, width = (this.stats, .75 * Base.window.width | 0), total = runner.total, stream = process.stdout, plane = color("plane", "✈"), crashed = -1, n = 0;
            runner.on("start", function() {
                stream.write("\n  ");
                cursor.hide();
            });
    ...
    require.register("reporters/nyan.js", function(module, exports, require) {
        function NyanCat(runner) {
            Base.call(this, runner);
            {
                var self = this, width = (this.stats, .75 * Base.window.width | 0), nyanCatWidth = (this.rainbowColors = self.generateColors(), 
    ...
    require.register("reporters/progress.js", function(module, exports, require) {
        function Progress(runner, options) {
            Base.call(this, runner);
            {
                var self = this, options = options || {}, width = (this.stats, .5 * Base.window.width | 0), total = runner.total, complete = 0;
                Math.max;
            }
            ...
            runner.on("test end", function() {
                complete++;
                var percent = complete / total, n = width * percent | 0, i = width - n;
                cursor.CR();
    ...
    require.register("reporters/xunit.js", function(module, exports, require) {
        ...
        function test(test) {
            ...
            } else console.log(test.pending ? tag("testcase", attrs, false, tag("skipped", {}, true)) : tag("testcase", attrs, true));
        }
    ...
    require.register("reporters/ti-spec-studio.js", function(module, exports, require) {
        function TiSpecStudio(runner) {
            ...
            runner.on("pass", function(test) {
                Ti.API.info("fast" === test.speed ? indent() + "  + " + test.title : indent() + "  + " + test.title + " (" + test.duration + "ms)");
            });
            runner.on("fail", function(test) {
    ...
    require.register("reporters/ti-spec.js", function(module, exports, require) {
        function TiSpec(runner) {
            ...
            runner.on("pass", function(test) {
                log("fast" === test.speed ? upOne() + color("checkmark", indent() + "  +") + color("pass", " " + test.title + " ") : upOne() + color("checkmark", indent() + "  +") + color("pass", " " + test.title + " ") + color(test.speed, "(" + test.duration + "ms)"));
            });
            runner.on("fail", function(test) {
    ...
    require.register("titanium/util.js", function(module, exports) {
        ...
        exports.format = function(f) {
            ...
            if (!isString(f)) {
                var objects = [];
                for (i = 0; i < arguments.length; i++) objects.push(inspect(arguments[i]));
                return objects.join(" ");
            }
            i = 1;
            var args = arguments;
    ...
    for (var i = 0; i < types.length; i++) createConsoleLogger(types[i]);
    mocha.setup({
        ui: "bdd",
        reporter: "ti-spec"
    });
